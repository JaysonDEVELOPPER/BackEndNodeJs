...
const {getAll,getByNames, getByIds,createUsers,updateUsers,loginUser} = require("../controllers/users-controllers") // router pour les allez chercher la function definis
